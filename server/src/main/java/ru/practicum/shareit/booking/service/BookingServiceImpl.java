...
public class BookingServiceImpl implements BookingService {
    ...
    @Transactional
    public List<BookingDto> getAllBookingByOwnerId(Integer ownerId, State state, Integer from, Integer size) {
    ...
    @Transactional
    public List<BookingDto> getAllBookingByUserId(Integer userId, State state, Integer from, Integer size) {
